  ...
  handleClick = (link) => {
    Linking.canOpenURL(link).then(supported => {
      if (supported) {
        ...
        console.log("Cannot open this url " + link)
      }
    })
  }
        ...
        <View style={[theme.cardStyle, styles.card]}>
          ...
          <View style={styles.textArea}>
            <MaterialIcon name{'assignment'}
              size={40} style={styles.textIcons}/>
            <Text style={theme.cardContentStyle} >
          ...
          <View>
            <TouchableOpacity
              onPress={()=>
                ...
                <Image source={require('../images/call@2x.png')}
                  style={styles.actionImage}/>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={()=>{this.handleClick
                ('sms:$(this.props.person.phone}')}}>
              <Image source={require('../images/sms@2x.png')}
                style={styles.actionImage}/>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={()=>{this.handleClick
                ('mailto:$(this.props.person.email}')}}>
              <Image source={require('../images/email@2x.png')}
                style={styles.actionImage}/>
            </TouchableOpacity>
          </View>
